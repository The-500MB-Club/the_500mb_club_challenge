// Steady state: 200 RPS, 10 min
// Mix: 60% POST single | 10% POST batch | 20% GET range | 10% GET anomaly
//
// Rodar: k6 run --env BASE_URL=http://<pi>:8080 k6/steady.js
// O gerador deve rodar FORA do Raspberry Pi.
...
export const options = {
  ...
  thresholds: {
    ...
    'http_req_duration{op:post}':    ['p(99)<200'],
    'http_req_duration{op:batch}':   ['p(99)<500'],
    'http_req_duration{op:range}':   ['p(99)<300'],
    'http_req_duration{op:anomaly}': ['p(99)<500'],
  },
